#ifndef ENEMY_GAME_OBJECT_BOXY_H_
#define ENEMY_GAME_OBJECT_BOXY_H_
...
class EnemyGameObjectBoxy : public GameObject {
public:
    //For the enemy state
    enum class State {
        Patrolling,
    ...
    EnemyGameObjectBoxy(const glm::vec3& position, Geometry* geom, Shader* shader, GLuint texture, GLuint destroy_texture, int hit_points);
...
#endif // ENEMY_GAME_OBJECT_BOXY_H_
